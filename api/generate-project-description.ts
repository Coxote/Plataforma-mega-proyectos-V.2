  ...
  try {
    ...
    const response = await ai.models.generateContent({
      ...
      contents: `
        ...
        Genera un borrador de descripcion / brief operativo ejecutivo en espanol, 2 a 3 parrafos bien estructurados, para un nuevo proyecto.
        ...
        - Horas Totales Estimadas: ${totalHours} hrs
        - Presupuesto/Ingreso: ${totalIncome ? `${totalIncome} ${currency || 'USD'}` : 'No definido'}

        Devuelve UNICAMENTE un objeto JSON con la clave "description".
      `,
      config: {
