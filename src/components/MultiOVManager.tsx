...
export const MultiOVManager: React.FC<MultiOVManagerProps> = ({
  ...
  return (
    <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs space-y-6" id="multi-ov-manager">
      {/* HEADER SECTION */}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        ...
        <div className="bg-slate-50/80 p-3.5 rounded-2xl border border-slate-200/70 flex items-center justify-between">
          <div>
            <span className="text-xs font-bold text-slate-400 uppercase tracking-wider block mb-1">Estados OVs</span>
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="border-b border-slate-200/80 text-xs font-bold text-slate-400 uppercase tracking-wider bg-slate-50/50">
              ...
              return (
                <tr key={ov.id} className="hover:bg-slate-50/60 transition-colors">
                  ...
                  <td className="py-3 px-3">
                    <span className={`inline-flex items-center gap-1 text-xs font-bold px-2.5 py-0.5 rounded-full border ${badge.bg}`}>
                    ...
                    <td className="py-3 px-3 text-right">
                      <div className="flex items-center justify-end gap-1">
                        ...
                        <select
                          ...
                          className="text-xs font-bold bg-slate-100 border border-slate-200 rounded px-1.5 py-1 text-slate-700 cursor-pointer focus:outline-none"
                        >
            ...
            <form onSubmit={handleSaveOV} className="space-y-4">
              ...
              <div className="p-3 bg-slate-50 rounded-2xl border border-slate-200 space-y-2">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-5 gap-2 pt-1">
                  <div>
                    <label className="block text-xs font-bold text-slate-600 uppercase mb-0.5">Supervisor</label>
                    <input
                      type="number"
                      min="0"
                      placeholder="0"
                  ...
                  <div>
                    <label className="block text-xs font-bold text-slate-600 uppercase mb-0.5">SAC / Consultor</label>
                    <input
                      type="number"
                      min="0"
                      placeholder="0"
                  ...
                  <div>
                    <label className="block text-xs font-bold text-slate-600 uppercase mb-0.5">Social Media</label>
                    <input
                      type="number"
                      min="0"
                      placeholder="0"
