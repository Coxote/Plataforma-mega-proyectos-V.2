...
export function createDefaultPhases(): Phase[] {
  return [
    ...
    },
    {
      ...
      label: 'QA',
      status: 'completed',
      completedAt: '2026-07-26T19:50:00.000Z',
      checklist: [
        ...
        { id: 'a6-3', text: 'Registrar y solucionar bugs críticos encontrados', completed: true },
        { id: 'a6-4', text: 'Realizar sesión de pruebas de aceptación (UAT) con cliente', completed: true },
      ],
      fields: {
        entornoTest: 'https://staging.acmeportal.com',
        bugsPendientes: '✔ 14/14 Casos de prueba ejecutados (100% Pass Rate).\n✔ 3/3 Bugs resueltos y validados en Staging.\n✔ Pruebas UAT aprobadas sin observaciones por cliente (María López - Product Lead).',
      },
    },
    {
      id: 'A7',
      ...
      fields: {
        ...
        notasEntrega: 'Fase de Entrega lista para ejecución final. Pendiente despliegue a producción y capacitación.',
      },
    },
    {
      id: 'A8',
      ...
      completedAt: null,
      checklist: [
        { id: 'a8-1', text: 'Activar protocolo de monitoreo Uptime 24/7 y alertas SLA', completed: false },
        { id: 'a8-2', text: 'Configurar bolsa mensual de horas para mantenimiento evolutivo', completed: false },
        { id: 'a8-3', text: 'Establecer mesa de ayuda (Helpdesk / Slack Support) con tiempos de respuesta', completed: false },
        { id: 'a8-4', text: 'Generar reporte mensual de métricas y balance de horas', completed: false },
      ],
      fields: {
        slaTier: 'SLA Nivel Oro (Respuesta Críticos < 1h | 15h Retainer/mes)',
        soporteContacto: 'soporte@agencia.com / Canal Slack #acme-support',
        metricasUptime: '99.98% Uptime | 0 Incidencias P1 en los últimos 30 días.',
        bolsaEvolutiva: '15.0 hrs/mes contratadas. Consumidas este mes: 4.5 hrs. Disponibles: 10.5 hrs.',
      },
    },
    {
      id: 'A9',
      label: 'Evaluación & Post-Mortem',
      status: 'pending',
      completedAt: null,
      checklist: [
        { id: 'a9-1', text: 'Medir satisfacción del cliente (NPS / CSAT) y obtener testimonio o caso de éxito', completed: false },
        { id: 'a9-2', text: 'Realizar reunión de Retrospectiva / Post-Mortem interna con el equipo', completed: false },
        { id: 'a9-3', text: 'Evaluar rentabilidad final, varianza de horas y presupuesto consumido vs estimado', completed: false },
        { id: 'a9-4', text: 'Archivar activos finales, repositorio y acordar roadmap de evolutivos futuros', completed: false },
      ],
      fields: {
        satisfaccionCliente: 'NPS: 10/10 | CSAT: 98%. "Excelentes tiempos de respuesta y calidad técnica."',
        balanceHorasRentabilidad: 'Planificadas: 80.0h | Consumidas: 74.5h (Ahorro del 6.87%). Rentabilidad: 38.2% EBITDA.',
        aprendizajesPostMortem: '1. El flujo de aprobaciones de entregables con cliente redujo revisiones innecesarias.\n2. Prototipado previo en Figma redujo el re-trabajo en un 40%.\n3. Oportunidad: Automatizar tests de carga antes de la fase de QA.',
        casoExitoRoadmap: 'Caso de éxito publicado en sitio corporativo. Cliente evaluando Módulo de Analítica Avanzada (Fase 2 en Q4).',
      },
    },
  ];
}
...
export const INITIAL_PROJECTS: Project[] = [
    ...
    phases: [
      ...
      },
      {
        ...
        fields: {
          ...
          comentariosCliente: 'Revisión aprobada sin objeciones por María López.',
        },
      },
      {
        id: 'A4',
        ...
        fields: {
          aprobador: 'María López (Product Lead)',
          metodoAprobacion: 'Firma electrónica DocuSign completada.',
        },
      },
      {
        id: 'A5',
        ...
        fields: {
          ...
          estadoDesarrollo: 'Código finalizado y desplegado en entorno de Staging.',
        },
      },
      {
        id: 'A6',
        label: 'QA',
        status: 'completed',
        completedAt: '2026-07-26T19:50:00Z',
        checklist: [
          { id: 'a6-1', text: 'Escribir casos de prueba funcionales', completed: true },
          { id: 'a6-2', text: 'Ejecutar pruebas en entorno de staging', completed: true },
          { id: 'a6-3', text: 'Registrar y solucionar bugs críticos encontrados', completed: true },
      ...
      },
      {
        ...
        checklist: [
          { id: 'a7-1', text: 'Realizar despliegue en producción final', completed: true },
          { id: 'a7-2', text: 'Entregar documentación técnica y manuales de usuario', completed: true },
          { id: 'a7-3', text: 'Capacitar al equipo administrador del cliente', completed: true },
          { id: 'a7-4', text: 'Cerrar formalmente el proyecto y firmar acta de entrega', completed: true },
        ],
        fields: {
          urlProduccion: 'https://portal.acme-corp.com',
          notasEntrega: '🚀 Despliegue en producción final realizado con éxito.\n✔ Dominio y certificado SSL/TLS activos (https://portal.acme-corp.com).\n✔ Documentación de API, arquitectura y manuales entregados en Notion y PDF.\n✔ Capacitación ejecutada con 8 usuarios administradores de Acme Corp.\n✔ Acta de Cierre Firmada por María López (Product Lead) el 26/07/2026.\n✔ Proyecto listo para Mantenimiento Evolutivo & SLA (Garantía 90 días).',
        },
      },
      {
        id: 'A8',
        label: 'SLA & Retainer',
        status: 'completed',
        completedAt: '2026-07-26T20:05:00Z',
        checklist: [
          { id: 'a8-1', text: 'Activar protocolo de monitoreo Uptime 24/7 y alertas SLA', completed: true },
          { id: 'a8-2', text: 'Configurar bolsa mensual de horas para mantenimiento evolutivo', completed: true },
          { id: 'a8-3', text: 'Establecer mesa de ayuda (Helpdesk / Slack Support) con tiempos de respuesta', completed: true },
          { id: 'a8-4', text: 'Generar reporte mensual de métricas y balance de horas', completed: true },
        ],
        fields: {
          slaTier: 'SLA Nivel Oro (Respuesta Críticos < 1h | 15h Retainer/mes)',
          soporteContacto: 'soporte@agencia.com / Canal Slack #acme-support',
          metricasUptime: '99.98% Uptime en los últimos 30 días. 0 Incidencias P1 o bloqueantes.',
          bolsaEvolutiva: '15.0 hrs/mes contratadas en Retainer. Consumidas en el ciclo actual: 4.5 hrs (Optimizaciones UI y parches menores). Saldo disponible: 10.5 hrs.',
        },
      },
      {
        id: 'A9',
        ...
        checklist: [
          { id: 'a9-1', text: 'Medir satisfacción del cliente (NPS / CSAT) y obtener testimonio o caso de éxito', completed: true },
          { id: 'a9-2', text: 'Realizar reunión de Retrospectiva / Post-Mortem interna con el equipo', completed: true },
          { id: 'a9-3', text: 'Evaluar rentabilidad final, varianza de horas y presupuesto consumido vs estimado', completed: true },
          { id: 'a9-4', text: 'Archivar activos finales, repositorio y acordar roadmap de evolutivos futuros', completed: true },
        ],
        fields: {
          satisfaccionCliente: '⭐ NPS: 10/10 | CSAT: 98%. Testimonio de María López: "Extraordinaria entrega. Cumplieron al 100% el alcance y presupuesto sin demoras."',
          balanceHorasRentabilidad: 'Planificadas: 80.0h | Consumidas: 74.5h (Ahorro del 6.87%). Rentabilidad final: 38.2% EBITDA sobre el proyecto.',
          aprendizajesPostMortem: '✔ El portal de entregables y visto bueno del cliente aceleró aprobaciones en un 50%.\n✔ Prototipado inicial redujo cambios de último minuto.\n✔ Oportunidad de mejora: Automatizar integración CI/CD desde el día 1.',
          casoExitoRoadmap: '✔ Caso de éxito publicado en portal corporativo.\n✔ Proyecto cerrado exitosamente.\n✔ Roadmap Fase 2 acordado para Q4 (Módulo de Analítica Avanzada).',
        },
      },
    ],
  },
  {
    ...
    deliverables: [
      {
        id: 'del-p2-1',
        title: 'Prototipo Interactive KYC Figma',
        type: 'link',
        externalUrl: 'https://figma.com/file/kyc-flow',
        uploadedBy: 'lucia',
  ...
  },
  {
    ...
    deliverables: [
      {
        id: 'del-p3-1',
        title: 'Informe Técnico de Mapeo y Particionamiento PostgreSQL',
        type: 'pdf',
        uploadedBy: 'carlos',
